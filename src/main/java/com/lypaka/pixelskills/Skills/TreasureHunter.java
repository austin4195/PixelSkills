...
public class TreasureHunter {
    ...
    public void onPokeLootOpen (PokeLootClaimedEvent e) {
        ...
        if (ConfigManager.getConfigNode("Skills", "Treasure Hunter", "isEnabled").getValue().equals(true)) {
            if (accountManager.getAccountsConfig().getNode(player.getUniqueId().toString(), "Skills", "Treasure Hunter", "Level").getInt() < ConfigManager.getConfigNode("Skills", "Treasure Hunter", "maxLevel").getInt()) {
